# Awesome List PR Tracker

py-ethclient를 외부 큐레이션 리스트에 등록하기 위해 제출한 PR 목록.

## Submitted PRs

| # | Repository | Stars | PR | Status | Date |
|---|-----------|------:|-----|--------|------|
...
|-----------|------:|--------|
| Consensys/ethereum-developer-tools-list | 5,439 | Repository archived (read-only) |
| gdamdam/awesome-decentralized-web | 1,679 | Explicitly excludes cryptocurrency projects |
| ong/awesome-decentralized-finance | 1,622 | DeFi only |
| Anugrahsr/Awesome-web3-Security | 1,536 | Security only |
| vinta/awesome-python | 283,944 | No blockchain category |
| bkrem/awesome-solidity | 7,015 | Solidity only |

## TODO

- [ ] ethereum.org 클라이언트 등록 시도
- [ ] PyPI 패키지 등록 후 관련 리스트 추가
